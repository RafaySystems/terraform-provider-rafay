...
require (
	...
	github.com/RafaySystems/rafay-common v1.29.1-rc2.0.20250729215820-ba15ce4555f7
...
require (
	...
	github.com/RafaySystems/eaas-playground/proto v0.0.0-20250714092203-c5165eb359eb // indirect
