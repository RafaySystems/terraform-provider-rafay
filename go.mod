...
require (
	...
	github.com/RafaySystems/rafay-common v1.29.1-rc2.0.20250623090645-3100dfca383c
...
require (
	...
	github.com/RafaySystems/eaas-playground/proto v0.0.0-20250623181652-e2dffdfde617 // indirect
