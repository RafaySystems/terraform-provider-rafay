...
require (
	github.com/RafaySystems/rafay-common v1.29.0-rc4.0.20230918063752-96c5c9d1907a
	github.com/RafaySystems/rctl v1.29.0
...
require (
	...
	github.com/RafaySystems/eaas-playground v0.0.0-20230915154546-5181de1c3519 // indirect
