...
require (
	github.com/RafaySystems/rafay-common v1.29.0-rc4.0.20230912123317-5b02e5f30077
...
require (
	...
	github.com/RafaySystems/eaas-playground v0.0.0-20230912083155-a7f9b1fe5717 // indirect
