...
func clusterAKSConfigNodePoolsFields() map[string]*schema.Schema {
	s := map[string]*schema.Schema{
		...
		"location": {
			Type:        schema.TypeString,
			Optional:    true,
			Description: "The AKS node pool location",
		},
		"count": {
			Type:        schema.TypeInt,
			Optional:    true,
		...
		"property_type": {
			...
			Description: "The AKS node pool property type. Valid values are VirtualMachineScaleSets, AvailabilitySet.",
		},
		"apiversion": {
			Type:        schema.TypeString,
			Optional:    true,
...
func clusterAKSConfigFields() map[string]*schema.Schema {
	s := map[string]*schema.Schema{
		...
		"enable_private_cluster": {
			...
			Optional:    true,
			Default:     true,
			Description: "By using a private cluster, you can ensure network traffic between your API server and your node pools remains on the private network only.",
		},
		"location": {
			Type:        schema.TypeString,
			Required:    true,
		...
		"loadbalancer_sku": {
			...
			Optional:    true,
			Default:     "standard",
			Description: "Azure Load Balancer SKU selection for your cluster. Accepted values: basic or standard",
		},
		"network_plugin": {
			Type:        schema.TypeString,
			Optional:    true,
		...
		"sku_tier": {
			...
			Optional:    true,
			Default:     "Free",
			Description: "Enable a paid managed cluster service with a financially backed SLA. Valid values are Paid, Free.",
		},
		"tags": {
			Type:        schema.TypeMap,
			Optional:    true,
		...
		"type": {
			...
			Description: "Metadata type for AKS managed cluster.",
		},
		"apiversion": {
			Type:        schema.TypeString,
			Optional:    true,
