...
- `disable_aws_node_termination_handler` - (Boolean) If enabled, AWS Node termination handler won't be installed on EKS cluster. It's for system blueprints except minimal.
