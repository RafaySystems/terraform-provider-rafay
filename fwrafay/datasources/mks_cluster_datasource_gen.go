...
func (t CreatedByType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	isSsouserAttribute, ok := attributes["is_ssouser"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`is_ssouser is missing from object`)

		return nil, diags
	}

	isSsouserVal, ok := isSsouserAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`is_ssouser expected to be basetypes.BoolValue, was: %T`, isSsouserAttribute))
	}
...
type CreatedByValue struct {
	...
	IsSsouser basetypes.BoolValue   `tfsdk:"is_ssouser"`
...
func (v CreatedByValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["is_ssouser"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.IsSsouser.ToTerraformValue(ctx)
...
func (v CreatedByValue) Equal(o attr.Value) bool {
	...
	if !v.IsSsouser.Equal(other.IsSsouser) {
		return false
	}
...
func (t ConfigType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	dedicatedMastersEnabledAttribute, ok := attributes["dedicated_masters_enabled"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`dedicated_masters_enabled is missing from object`)

		return nil, diags
	}

	dedicatedMastersEnabledVal, ok := dedicatedMastersEnabledAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`dedicated_masters_enabled expected to be basetypes.BoolValue, was: %T`, dedicatedMastersEnabledAttribute))
	}
	...
	return ConfigValue{
		...
		DedicatedMastersEnabled: dedicatedMastersEnabledVal,
...
type ConfigValue struct {
	...
	DedicatedMastersEnabled basetypes.BoolValue   `tfsdk:"dedicated_masters_enabled"`
...
func (v ConfigValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["dedicated_masters_enabled"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.DedicatedMastersEnabled.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["dedicated_masters_enabled"] = val
...
func (v ConfigValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"dedicated_masters_enabled": basetypes.BoolType{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"dedicated_masters_enabled": v.DedicatedMastersEnabled,
...
func (v ConfigValue) Equal(o attr.Value) bool {
	...
	if !v.DedicatedMastersEnabled.Equal(other.DedicatedMastersEnabled) {
		return false
	}
...
func (t DaemonSetOverrideType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	daemonSetTolerationsVal, ok := daemonSetTolerationsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`daemon_set_tolerations expected to be basetypes.ListValue, was: %T`, daemonSetTolerationsAttribute))
	}
...
type DaemonSetOverrideValue struct {
	DaemonSetTolerations basetypes.ListValue `tfsdk:"daemon_set_tolerations"`
...
func (v DaemonSetOverrideValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["daemon_set_tolerations"] = basetypes.ListType{
...
func (v DaemonSetOverrideValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	daemonSetTolerations := types.ListValueMust(
	...
	if v.DaemonSetTolerations.IsNull() {
		daemonSetTolerations = types.ListNull(
			DaemonSetTolerationsType{
				basetypes.ObjectType{
					AttrTypes: DaemonSetTolerationsValue{}.AttributeTypes(ctx),
				},
	...
	if v.DaemonSetTolerations.IsUnknown() {
		daemonSetTolerations = types.ListUnknown(
			DaemonSetTolerationsType{
				basetypes.ObjectType{
					AttrTypes: DaemonSetTolerationsValue{}.AttributeTypes(ctx),
				},
	...
	attributeTypes := map[string]attr.Type{
		"daemon_set_tolerations": basetypes.ListType{
			ElemType: DaemonSetTolerationsValue{}.Type(ctx),
		},
