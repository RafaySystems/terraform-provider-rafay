...
require (
	...
	github.com/RafaySystems/rafay-common v1.29.1-rc2.0.20240822060409-a97df8f7e1e4
...
require (
	...
	github.com/RafaySystems/eaas-playground v0.0.0-20240821131920-377f27cd2a4d // indirect
