...
require (
	github.com/RafaySystems/edge-common v1.24.1-0.20240905125603-71786cb8b3dc
	github.com/RafaySystems/rafay-common v1.29.1-rc2.0.20240905124139-d29b936ef53b
