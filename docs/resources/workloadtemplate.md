...
- `metadata` (Block List, Max: 1) Metadata of the workload template resource (see [below for nested schema](#nestedblock--metadata))
- `spec` (Block List, Max: 1) Specification of the workload template resource (see [below for nested schema](#nestedblock--spec))
...
- `artifact` (Block List, Max: 1) workload template artifact specification (see [below for nested schema](#nestedblock--spec--artifact))
- `sharing` (Block List, Max: 1) workload template sharing configuration (see [below for nested schema](#nestedblock--spec--sharing))
