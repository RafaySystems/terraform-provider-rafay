...
Example to run two stages (stage1 & stage2) in parrallel

> Order of execution is decided by the `next` property. We can omit `next` to remove dependencies in between stages and run them in parrallel.
