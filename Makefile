...
test:
	...
	@TF_ACC=1 GOLANG_PROTOBUF_REGISTRATION_CONFLICT=ignore go test -v -parallel 1 ./tests/integration/negative/...
	@echo ""
	@echo "=========================================="
...
test-cover:
	...
	@TF_ACC=1 GOLANG_PROTOBUF_REGISTRATION_CONFLICT=ignore go test -v -cover -parallel 1 ./tests/integration/negative/...
	@echo ""
	@echo "=========================================="
