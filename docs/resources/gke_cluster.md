...
resource "rafay_gke_cluster" "tf-example" {
  ...
  spec {
    ...
    config {
      ...
      network {
        name = "projects/abc/global/networks/n1"
        subnet_name = "projects/abc/regions/us-central1/subnetworks/n1"
        enable_vpc_nativetraffic = "true"
        max_pods_per_node        = 110
        pod_secondary_range_name = "pod-range-name"
...
```
-----
Cluster with nodes-autoupgrade enabled for a nodepool
