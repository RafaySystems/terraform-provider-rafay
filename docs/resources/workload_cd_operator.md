...
- [Usage](#usage)
  - [Workload Deployer Resource](#workload-deployer-resource)
    - [Features](#features)
  - [Path Match Pattern](#path-match-pattern)
    - [Example1](#example1)
	- [Example2](#example2)
  - [Base Path](#base-path)
- [Examples](#examples)
...
The deployment process is designed to manage Helm charts organized in a folder structure that reflects the project name, namespace, and workload name.
...
2. Deletes the workloads from the project when corresponding folders or values are removed from the repository.
