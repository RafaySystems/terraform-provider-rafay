...
func TestResourceDriver(t *testing.T) {
	expectedName := randomString("test-driver", 10)
	// Make a copy of the terraform module to a temporary directory. This allows running multiple tests in parallel
	// against the same terraform module.
	exampleFolder := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/resources/rafay_driver")
	...
	resourceName := terraform.Output(t, terraformOptions, "driver_name")
