...
require (
	github.com/RafaySystems/edge-common v1.24.1-0.20260212070348-cebe2ecf6af1
	github.com/RafaySystems/rafay-common v1.29.1-rc2.0.20260216061535-571ee781d37a
	github.com/RafaySystems/rctl v1.29.1-0.20260212104810-239fcbc7080d
