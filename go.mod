...
require github.com/RafaySystems/rafay-common v1.29.1-rc2.0.20250410064812-79948e8478a7

require (
	github.com/IBM/sarama v1.43.2 // indirect
	github.com/Masterminds/sprig v2.22.0+incompatible // indirect
	github.com/RafaySystems/eaas-playground/proto v0.0.0-20250407083647-1eb84c08deb9 // indirect
