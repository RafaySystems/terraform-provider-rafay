	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			"project": schema.StringAttribute{
				Required:    true,
				Description: "Project that contains the cluster.",
			},
			"cluster_name": schema.StringAttribute{
				Optional:    true,
				Description: "Name of the cluster to fetch Kubernetes versions.",
			},
			"cluster_type": schema.StringAttribute{
				Required:    true,
				Description: "The type of the cluster. Example: \"mks\".",
			},
			"default_version": schema.StringAttribute{
				Computed:    true,
				Description: "The default Kubernetes version for the cluster.",
			},
			"latest_version": schema.StringAttribute{
				Computed:    true,
				Description: "The latest supported Kubernetes version.",
			},
...
func (d *ClusterKubernetesVersionsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	clusterType := config.ClusterType.ValueString()
